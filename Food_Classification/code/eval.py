...
#log_dir = '../dataset/checkpoint'
log_dir = '../logs/wrapup1'
...
checkpoint_file = log_dir + '/model.ckpt-3743'
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        with slim.arg_scope(inception_resnet_v2_arg_scope()):
            logits, end_points = inception_resnet_v2(images, num_classes = dataset.num_classes, is_training = True, dropout_keep_prob=1.0)
