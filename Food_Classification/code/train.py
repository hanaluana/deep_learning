...
#checkpoint_file = '/dataset/checkpoint/inception_resnet_v2_2016_08_30.ckpt'
#checkpoint_file = '/dataset/checkpoint/model.ckpt-2457'
checkpoint_file = '/premodel/log/model.ckpt-4350' # for continue train
#checkpoint_file = '/dataset/checkpoint/model.ckpt-4350' # for evaluate
...
#labels_file = '../dataset/labels.txt' #for evaluate
...
#file_pattern_for_counting = 'test5'
#file_pattern = file_pattern_for_counting + '_%s_*.tfrecord'
...
batch_size = 32 #32 # gpu 
#batch_size = 8 # cpu

#Learning rate information and configuration (Up to you to experiment)
initial_learning_rate = 0.0002 #0.001 #0.0009
...
def run():
    ...
    with tf.Graph().as_default() as graph:
        ...
        images, _, labels = load_batch(dataset, batch_size=batch_size, is_training=False)
